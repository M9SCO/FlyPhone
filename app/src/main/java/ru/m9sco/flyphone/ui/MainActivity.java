...
public class MainActivity extends AppCompatActivity implements IQSourceInterface.Callback, RFControlInterface {
    ...
    ConstraintLayout fl_base;
    Button btn_freqMines, btn_freqPlus, btn_freq;
    TextView txt_freq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_freqPlus.setText("");
        btn_freqPlus.setCompoundDrawablesWithIntrinsicBounds(
                null,
                getDrawable(R.drawable.r_up),
                null,
                null
        );
        btn_freqMines.setText("");
        btn_freqMines.setCompoundDrawablesWithIntrinsicBounds(
                null,
                null,
                null,
                getDrawable(R.drawable.r_down)
        ...
        fl_base = (ConstraintLayout) findViewById(R.id.fl_base);
